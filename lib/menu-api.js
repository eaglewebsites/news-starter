...
/** Base API (reads from helper; supports NEXT_PUBLIC_EAGLE_BASE_API / EAGLE_BASE_API with legacy fallbacks) */
  ...
  for (const siteParam of candidates) {
    ...
    try {
      const res = await fetch(url, {
        ...NO_STORE, // SSR: avoid stale menus
        headers: {
